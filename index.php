...
Hebrew:</font><br>&nbsp;&nbsp;
<textarea name=q 
rows=5 cols=45 wrap=PHYSICAL><?php generateTransliteration($_POST['sourcetext'], $_POST['targetlang'], strpos($_SERVER["HTTP_USER_AGENT"], "Firefox"), strpos($_SERVER["HTTP_USER_AGENT"], "Opera"));?>
...
border=0><tr bgcolor=#ffffff><td><form action=transliterate.php 
